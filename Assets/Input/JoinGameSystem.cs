        ...
        if (indicatorRenderer != null)
        {
            if (team == 1)
            {
                if (playerInput.gameObject.CompareTag("Offense")) {
                    playerInput.gameObject.transform.position = new UnityEngine.Vector3(-25, 1.1f, -11);
                } else {
                    playerInput.gameObject.transform.position = new UnityEngine.Vector3(-25, 1.1f, -7);
                }
